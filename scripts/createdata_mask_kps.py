...
sys.path.insert(0, '/home/wuliang/Workspace/Caffe/caffe-maskYolo/python')
sys.path.insert(0, '/home/wuliang/Workspace/Python/cocoapi/PythonAPI/')
...
(dst_h, dst_w) = [320, 320]
lmdb_path = '/media/wuliang/Data/Machine_Learning/lmdb/coco_kps_val_320-100/'
...
dataDir = '/media/wuliang/Data/Machine_Learning/ImageSet/COCO/'
